...
public class Vapor : MonoBehaviour
{
    ...
    [Tooltip("Properties to blend towards controlled by the blend time")]
    [SerializeField]
    ...
    /// </summary>
    public static VaporSetting DefaultSetting => new VaporSetting();
    ...
    void OnEnable()
    {
        ...
        m_vaporCompute = RoR2VaporAssets.Bundle.LoadAsset<ComputeShader>("VaporSim");
        ...
        m_fogMat = new Material(RoR2VaporAssets.Bundle.LoadAsset<Shader>("VaporPost")) { hideFlags = HideFlags.HideAndDontSave };

        NoiseTexture = RoR2VaporAssets.Bundle.LoadAsset<Texture2D>("NoiseTex");
        m_blueNoiseTex = RoR2VaporAssets.Bundle.LoadAsset<Texture2D>("BlueNoise");
