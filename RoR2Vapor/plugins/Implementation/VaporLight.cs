...
public class VaporLight : VaporObject
{
    ...
    static Material ShadowFilterMaterial
    {
        get
        {
            ...
            {
                s_shadowFilterMaterial = new Material(RoR2VaporAssets.Bundle.LoadAsset<Shader>("VaporShadowFilterESM"));
            }
    ...
    static Material ScreenShadowMaterial
    {
        get
        {
            ...
            {
                s_screenShadowMaterial = new Material(RoR2VaporAssets.Bundle.LoadAsset<Shader>("VaporShadowProperties"));
            }
    ...
    static Material ShadowBlurMaterial
    {
        get
        {
            ...
            {
                s_shadowBlurMaterial = new Material(RoR2VaporAssets.Bundle.LoadAsset<Shader>("VaporShadowBlur"));
            }
